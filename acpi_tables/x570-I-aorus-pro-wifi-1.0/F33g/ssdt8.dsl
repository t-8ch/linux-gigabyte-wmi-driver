 ...
 *
 * Disassembly of ssdt8.dat, Mon Apr  5 10:51:04 2021
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000B1BA (45498)
 *     Revision         0x01
 *     Checksum         0x1F
 *     OEM ID           "GBT"
 *     OEM Table ID     "GSWApp"
...
DefinitionBlock ("", "SSDT", 1, "GBT", "GSWApp", 0x00000001)
{
    ...
    Scope (\)
    {
        Device (GSA1)
        {
            ...
            OperationRegion (GGGT, SystemMemory, 0xBCD13B18, 0x0100)
